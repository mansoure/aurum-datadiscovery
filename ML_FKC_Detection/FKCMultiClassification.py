...
# sss = StratifiedShuffleSplit(n_splits=5, test_size=0.85, random_state=seed)
...
# print('knn', confusion_matrix(Y_validation, predictions))
# print('knn', classification_report(Y_validation, predictions))
